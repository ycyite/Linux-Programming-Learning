...
insert into track(cd_id, track_id, title)values(3, 1, 'Change the rythme');
insert into track(cd_id, track_id, title)values(3, 2, 'Close my eye');
insert into track(cd_id, track_id, title)values(4, 1, 'Sweep the floor');
